...
import { LayoutDashboard, Images, Settings, Briefcase, Link as LinkIcon, LogOut, Home } from 'lucide-react';
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-[#111] border-r border-white/10 min-h-screen flex flex-col">
